                        ...
                        <div class="table-responsive scrollbar">
                          <table class="table table-bordered table-striped fs--1 mb-0">
                            <thead class="bg-200 text-900">
                              <tr>
                                ...
                                <th class="sort" data-sort="age">subject</th>
                                <th class="sort" data-sort="age">message</th>
                          ...
                          @foreach ($contacts as $item)
                              <tr>
                                ...
                                <td>{{ $item->message }}</td>
                                <td>
                                    <a href="/admin/contacts/delete/{{ $item->id }}" class="btn btn-success " type="button">Déja vu</a>
                                </td>
                              </tr>
                          @endforeach
                            </tbody>
