...
@include('admin.include.navbar')
        ...
        <div class="content">
          <div class="pb-5">
             ...
             <hr>
             <div class="mt-2">
              <form action="/admin/admin/search" method="post">
                @csrf
                <div class="row">
                  <div class="col-5">
                    <input class="form-control" type="text" name="admin_name" placeholder="taper un nom ...">
                  </div>
                  <div class="col-2">
                        ...
                        <div class="table-responsive scrollbar">
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <a href="/admin/{{ $item->id }}/delete" class="btn btn-danger">supprimer</a>
                            </td>
                         </tr>
                          @endforeach
                            </tbody>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlInput1" name="name" type="text" placeholder="Nom ">
                @error('name')
              ...
              <div class="mb-3">
                ...
                <input class="form-control" id="exampleFormControlInput1" name="email" type="text" placeholder="Email ">
                @error('email')
                    <div class="btn btn-danger">
                        {{ $message }}
                    </div>
              ...
              <div class="mb-0">
                <label class="form-label" for="exampleTextarea">Password</label>
            ...
            @enderror
              ...
              <div class="mb-0">
                <label class="form-label" for="exampleTextarea">image</label>
...
<div class="modal fade" id="editCategory{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Modifier Admin :<span class="text-primary">{{ $item->name }}</span></h5><button class="btn p-1" type="button" data-bs-dismiss="modal" aria-label="Close"><span class="fas fa-times fs--1"></span></button>
      </div>
      <form action="/admin/update" method="POST" enctype="multipart/form-data">
        @csrf
      <div class="modal-body">
            <div class="mb-3">
              <input type="hidden" value="{{ $item->id }}" name="id_admin">
                <label class="form-label" for="exampleFormControlInput1">Nom  </label>
                <input class="form-control" id="exampleFormControlInput1" name="name" type="text" placeholder="Nom " value="{{ $item->name }}">
                @error('name')
                    <div class="btn btn-danger">
                        {{ $message }}
                    </div>
              ...
              <div class="mb-3">
                  <label class="form-label" for="exampleFormControlInput1">Email  </label>
                  <input class="form-control" id="exampleFormControlInput1" name="email" type="text" placeholder="Nom email" value="{{ $item->email }}">
                  @error('email')
                      <div class="btn btn-danger">
                          {{ $message }}
                      </div>
                ...
                <div class="mb-3">
                      ...
                      <input class="form-control" id="exampleFormControlInput1" name="password" type="password" placeholder="Password" >
                      @error('password')
                          <div class="btn btn-danger">
                              {{ $message }}
                          </div>
